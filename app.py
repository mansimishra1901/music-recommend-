...
SPOTIPY_CLIENT_ID='e333b924ad9d4ed39c1fe2f7528bfb3f'
SPOTIPY_CLIENT_SECRET='c15935c3eb504414af0eccc7dcef528b'

auth_manager = SpotifyClientCredentials(client_id=SPOTIPY_CLIENT_ID, client_secret=SPOTIPY_CLIENT_SECRET)
sp = spotipy.Spotify(auth_manager=auth_manager)

st.header('Music Analysis And Recommendation')
                ...
                with col12:  
                    ...
                    with col4:
                        def similar_songs_requested():
                            ...
                            with col31:
                                songrecommendations.song_recommendation_vis(recommendation_df)
                        similar_songs_state = st.button('Similar Songs', key=f"similar_button_{track['id']}", on_click=similar_songs_requested)
                        st.write('----')